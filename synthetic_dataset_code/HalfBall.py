...
class Half_Ball_Dataset():
    def __init__(self, obj_name, seed):
        ...
        self.train_fov, self.val_fov, self.test_fov = self.get_cam_fov_half_ball()
        self.loc_train, self.loc_val, self.loc_test,\
        self.rot_train, self.rot_val, self.rot_test = self.get_cam_pose_half_ball()
        self.render_set()
    ...
    def init_camera(self):
        ...
        for idx in range(max(self.numb_train_val, self.numb_test)):
            ...
            cur_cam.name = "Half_Ball_{}".format(idx)
    ...
    def get_cam_fov_half_ball(self):
        fov_angle_train = []
        fov_angle_val = []
    ...
    def get_cam_pose_half_ball(self):
...
if __name__ == "__main__":
    seed_dict = {"Lego":0,
                 ...
                 "Train":7}
    cur_data = "Train"
    dataset = Half_Ball_Dataset(obj_name = "HalfBall_{}".format(cur_data), seed=seed_dict[cur_data])
